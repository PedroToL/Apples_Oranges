...
# ENIGH 2018 ----
## Viviendas 
viv <- read.dbf("./Data/ENIGH/2016/viviendas.dbf")
...
## Hograes
hog <- read.dbf("./Data/ENIGH/2016/hogares.dbf")
...
## Concentrado Hogar
conc <- read.dbf("./Data/ENIGH/2016/concentradohogar.dbf")
...
## Población 
pob  <- read.dbf("./Data/ENIGH/2016/poblacion.dbf")
...
## Ingresos 
ing <- read.dbf("./Data/ENIGH/2016/ingresos.dbf")
